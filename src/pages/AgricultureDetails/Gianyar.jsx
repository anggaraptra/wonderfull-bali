...
export default function Gianyar() {
  return (
    <>
      <Navbar />
      <Section className="flex flex-col items-center justify-center bg-cover min-h-screen bg-blend-overlay bg-black/80 bg-[url(./img/agriculture/gianyar.jpg)] text-white">
        <div className="">
        ...
        <div className="flex flex-col gap-16 md:gap-20">
          <div className="flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-0">
            ...
            <div className="flex flex-col gap-4 justify-center md:gap-10">
              ...
              <p className="text-justify md:text-xl">Cabai adalah buah dan tumbuhan anggota genus Capsicum. Buahnya dapat digolongkan sebagai sayuran maupun bumbu, tergantung bagaimana pemanfaatannya.</p>
              <div className="flex flex-row items-center gap-4">
                ...
                <span className="text-second font-bold md:font-lg">Rp 55.000</span>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-0">
            ...
            <div className="flex flex-col gap-4 justify-center md:gap-10">
              ...
              <p className="text-justify md:text-xl">Kelapa atau nyiur adalah anggota tunggal dalam genus Cocos dari Arecaceae. Arti kata kelapa dapat merujuk pada keseluruhan pohon kelapa, biji, atau buah, yang adalah pohon. </p>
              <div className="flex flex-row items-center gap-4">
                <button className="px-5 py-2 bg-second text-white rounded-xl md:px-8 md:py-3 md:text-xl hover:bg-green-700 hover:drop-shadow-lg hover:shadow-md transition-all">Tambahkan</button>
                <span className="text-second font-bold md:font-lg">Rp 14.000</span>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-0">
            ...
            <div className="flex flex-col gap-4 justify-center md:gap-10">
              ...
              <p className="text-justify md:text-xl">Jagung adalah salah satu tanaman pangan penghasil karbohidrat yang terpenting di dunia. Bulir jagung adalah salah satu pangan pokok, bagi beberapa daerah di Indonesia.</p>
              <div className="flex flex-row items-center gap-4">
                <button className="px-5 py-2 bg-second text-white rounded-xl md:px-8 md:py-3 md:text-xl hover:bg-green-700 hover:drop-shadow-lg hover:shadow-md transition-all">Tambahkan</button>
                <span className="text-second font-bold md:font-lg">Rp 10.000</span>
              </div>
            </div>
          </div>
        </div>
