...
export default function Kintamani() {
  return (
    <>
      <Navbar />
      <Section className="flex flex-col items-center justify-center bg-cover bg-center h-[40rem] bg-blend-overlay bg-black/80 bg-[url(/img/agriculture/kintamani.webp)] text-white dark:bg-black/90 transition-all">
        ...
        <div className="container mx-auto flex flex-col gap-16 md:gap-20 px-12 dark:text-white transition-all">
          <div className="flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-0">
            <div className="max-w-lg">
              <img src="/img/agriculture/jeruk_kintamani.webp" alt="" className="h-auto max-w-full rounded-xl" />
            </div>
            <div className="flex flex-col gap-4 justify-center md:gap-10">
              <h3 className="font-bold text-3xl md:text-5xl">Jeruk</h3>
              <article className="text-justify md:text-xl dark:text-gray-400">
                Jeruk adalah buah dari spesies citrus dalam famili Rutaceae. Istilah &quot;jeruk&quot; umumnya mengacu pada Citrus × sinensis yang juga disebut jeruk manis.{' '}
              </article>
          ...
          <div className="flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-0">
            <div className="max-w-lg">
              <img src="/img/agriculture/kopi_bali.webp" alt="" className="h-auto max-w-full rounded-xl" />
            </div>
            <div className="flex flex-col gap-4 justify-center md:gap-10">
              <h3 className="font-bold text-3xl md:text-5xl">Kopi</h3>
              <article className="text-justify md:text-xl dark:text-gray-400">Kopi atau kahwa adalah tanaman industri pertanian yang dijadikan minuman hasil seduhan biji kopi yang telah disangrai dan dihaluskan menjadi bubuk. </article>
              <div className="flex flex-row items-center gap-4">
                <button className="px-5 py-2 bg-second text-white rounded-xl md:px-8 md:py-3 md:text-xl hover:bg-green-700 hover:drop-shadow-lg hover:shadow-md transition-all dark:bg-blue-500 dark:hover:bg-gray-700">Tambahkan</button>
          ...
          <div className="flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-0">
            <div className="max-w-lg">
              <img src="/img/agriculture/salak_bali.webp" alt="" className="h-auto max-w-full rounded-xl" />
            </div>
            <div className="flex flex-col gap-4 justify-center md:gap-10">
              <h3 className="font-bold text-3xl md:text-5xl">Salak</h3>
              <article className="text-justify md:text-xl dark:text-gray-400">
