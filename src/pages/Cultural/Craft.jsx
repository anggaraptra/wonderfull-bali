        ...
        <div className="flex flex-col text-white md:p-8">
          ...
          <div className="grid auto-rows-fr gap-8 md:grid-cols-2 pb-10 md:p-16">
            <div className="grid grid-rows-3 justify-items-center items-center">
              ...
              <p className="text-center font-thin md:text-xl dark:text-gray-400">
              ...
              <div className="">
                <a href="" className="text-center bg-second px-10 py-3 rounded-2xl font-medium hover:bg-green-700 hover:drop-shadow-lg hover:shadow-md transition-all dark:bg-blue-500 dark:hover:bg-gray-700">
                  Selengkapnya
                </a>
              </div>
            </div>
      ...
      <Section className="bg-white dark:bg-gray-800 transition-all">
        <div className="container mx-auto p-6 pb-20">
          <div className="flex flex-col items-center font-bold pt-8 pb-10 md:pt-16 md:pb-20">
            <h1 className="text-3xl md:text-4xl drop-shadow-lg border-b-4 border-second dark:text-white dark:border-blue-500">Kerajinan Bali</h1>
          </div>
