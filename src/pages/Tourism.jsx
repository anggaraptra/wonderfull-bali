      ...
      <Section className="p-10 dark:bg-gray-800 transition-all">
        ...
        <div className="flex flex-col gap-10 md:flex-row md:content-center md:items-center md:align-center md:p-16 dark:text-white transition-all">
          <div className="flex flex-col gap-5 items-center text-center">
            ...
            <p className="px-8 dark:text-gray-400 transition-all">
              Lorem ipsum dolor sit amet, consectetur asadipiscing elit. Phasellus at nibh sit amet lacus gravida ultrices ut ut elit. Morbi sagittis dignissim purus finibus congue. Integer exesre nulla.
            </p>
            <div className="">
              <button className="bg-second px-6 py-3 rounded-2xl text-white uppercase hover:bg-green-700 hover:drop-shadow-lg hover:shadow-md dark:bg-blue-500 dark:hover:bg-gray-700 transition-all">Read More</button>
            </div>
          </div>
          <div className="flex flex-col gap-5 items-center text-center">
            <div className="text-8xl">
